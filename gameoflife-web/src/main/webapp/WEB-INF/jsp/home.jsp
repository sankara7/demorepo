...
<head>
	...
	})(window,document,'script','http://10.106.131.14:6080/gameoflife/stagemonitor/public/eum.js','ineum');
	
	ineum('reportingUrl', 'http://10.106.131.14:6080/gameoflife/stagemonitor/public/eum');
	ineum('maxLengthForImgRequest', 2000);
	ineum('disableResourceTimingTransmission', false);
	</script>
